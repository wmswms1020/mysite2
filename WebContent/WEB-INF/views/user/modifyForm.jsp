...
<body>
	<div id="wrap">
					...
					<div id="modifyForm">
						<form action="" method="">
							...
							<div class="form-group">
								...
								<input type="text" id="input-pass" name="" value="<%=userVo.getPassword() %>" placeholder="비밀번호를 입력하세요"	>
							</div>
	
							<!-- 이메일 -->
							<div class="form-group">
								<label class="form-text" for="input-name">이름</label> 
								<input type="text" id="input-name" name="" value="<%=userVo.getName() %>" placeholder="이름을 입력하세요">
							</div>
		...
		<div id="footer">
			Copyright ⓒ 2020 소준호. All right reserved
		</div>
		<!-- //footer -->
